...
<div class="top" >
   ...
   <li><a  class="nav-link"style="position:relative;top:-325px;right:-150px;color:white" onclick="closeNav() "><b>X</b></a></li>
           ...
           <a href="<%=request.getContextPath()%>/newusermaster?empname=<c:out value='${emp.empname}' />"class="btn btn-success"style="background-color:#7fdbd4;border-color:white;border-radius:5px;position:relative;left:285px;top:-10px"><b>New</b></a>
           

                <div class="container">
                    <h5 style="position:relative;top:-40px"class="text-center"><b>User Master</b> </h5>
                    <hr style="position:relative;top:-40px">
                   

   <label style="color:grey;font-size:12px;position:relative;left:900px;top:-80px"><i>Total No of Records:</i></label>            
 <label style="position:relative;font-size:12px;left:910px;top:-80px">${fn:length(listUsermaster)}</label>
                    ...
                    <table id="tablepaging" class="table table-bordered"style="width:900px;position:relative;left:180px;top:-80px">
                        ...
                        <tbody>
                            <!--   for (Todo todo: todos) {  -->
                            <c:forEach var="usermaster" items="${listUsermaster}">

                                <tr style="font-size:12px">
                         
                                   
                                     <td>
                                         <a href="editUM?id=<c:out value='${usermaster.id}' />&empname=<c:out value='${emp.empname}' />"><c:out value="${usermaster.empname}" /></a> &nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                   
                       
                              <td>
                                        <c:out value="${usermaster.loginname}" />
                                        </td>
                                         <td>
                                        <c:out value="${usermaster.passwordd}" />
                                        </td>
                                          <td>
                                        <c:out value="${usermaster.user}" />
                                        </td>
                                         <td>
                                        <c:out value="${usermaster.emailid}" />
                                        </td>
                                                 <td>
                              <c:out value="${usermaster.ehide}"/>
                              </td>
